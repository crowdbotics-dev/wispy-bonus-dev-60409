"""
Django settings for wispy_bonus_dev_60409 project.
...
ROOT_URLCONF = 'wispy_bonus_dev_60409.urls'
...
WSGI_APPLICATION = 'wispy_bonus_dev_60409.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_bonus_dev_60409 API",
    "DESCRIPTION": "API documentation for wispy_bonus_dev_60409 App",
    "VERSION": "v1",
}
